...
void main() => runApp(MaterialApp(home: HeatStressTracker()));
...
class _HeatStressTrackerState extends State<HeatStressTracker> {
  ...
  String _result = "Press button to calculate";
  ...
  void _calculate() {
    ...
    if (heatIndex >= 54) { flag = "Red 🔴"; risk = "Stop work"; workRest = "Stop work"; water = "Stop work"; }
    else if (heatIndex >= 50) { flag = "Red 🔴"; risk = "Extreme Danger"; workRest = "20:10"; water = "1 cup every 10 min"; }
    else if (heatIndex >= 39) { flag = "Orange 🟠"; risk = "Danger"; workRest = "30:10"; water = "1 cup every 15 min"; }
    else if (heatIndex >= 32) { flag = "Yellow 🟡"; risk = "Extreme Caution"; workRest = "40:10"; water = "1 cup every 20 min"; }
    else { flag = "Green 🟢"; risk = "Caution"; workRest = "50:10"; water = "1 cup every 20 min"; }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(padding: EdgeInsets.all(16), child: Column(children: [
        ...
        TextField(controller: _tempController, decoration: InputDecoration(labelText: "Temp"), keyboardType: TextInputType.number),
